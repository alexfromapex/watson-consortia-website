...
export default function ThreeDModeling() {
  ...
  return (
    <>
      <title>3D Rendering &amp; Modeling - Watson Consortia</title>
      <main className="main">
        <div className="container-fluid">
          <div className="row pb-3">
            <div className={`row hero align-items-center justify-content-end`}>
              <h1 className="col-xl-6 fade-in-right">3D Rendering &amp; Modeling</h1>
            </div>
          </div>
        </div>
        <div className="container py-5">
      <header className="text-center mb-5">
        <h1 className="display-4 fw-bold mb-3">3D Rendering &amp; Modeling Solutions</h1>
