...
{/* BEGIN */}
                <section className="col-xs-12 col-md-12 col-lg-12 col-xl-10 mx-auto mb-5">
                ...
                <section className="col-xs-12 col-md-12 col-lg-12 col-xl-10 mt-5 mx-auto">
                ...
                <section className="col-xs-12 col-md-12 col-lg-12 col-xl-10 mx-auto fade-in-top">
                ...
                <section className="col-xs-12 col-md-12 col-lg-12 col-xl-10 mx-auto fade-in-top pb-5">
...
{/* END */}
                ...
                <section className="col-xs-12 col-md-12 col-lg-12 col-xl-10 d-flex flex-row flex-wrap container mx-auto mt-5 fade-in-top pb-5 align-items-center">
